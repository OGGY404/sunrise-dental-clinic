...
CAPTIONS = {
 "01-use-case":                    "Use case diagram for the Sunrise Dental Clinic system.",
 "02-class-domain":                "Domain model: attribute types, method signatures, visibility, multiplicity, navigability, aggregation and composition.",
 "03-class-layers":                "The three tiers, and the direction in which dependencies are allowed to point.",
 "04-class-design-patterns":       "Factory, Strategy, Template Method, Observer and Singleton in the business tier.",
 "05-sequence-login":              "Sequence: signing in (FR1).",
 "06-sequence-register-appointment":"Sequence: registering an appointment (FR2), with both failure paths.",
 "07-sequence-generate-bill":      "Sequence: calculating and printing the bill (FR4).",
 "26-database-triggers-audit":     "The ten triggers, the audit rows they wrote unaided, and the generated total column.",
 "04-booking-form-rejected":       "A rejected booking form: five fields marked, each with its own message, and every value kept.",
 "02-dashboard-menu":              "The main menu, with today's diary and the money outstanding.",
 "05-appointment-details-booked":  "Appointment details for a booked visit, with the actions available in that state.",
 "12-bill-print-preview":          "The bill as printed: the print stylesheet removes the menu, buttons and background.",
 "25-tdd-red-commit":              "A red commit: seven files changed, every one a test file, nothing in src/main.",
 "24-tests-passing":               "The full suite: 262 tests, 0 failures, 0 errors.",
 "20-jacoco-coverage":             "JaCoCo coverage report.",
 "21-github-actions":              "GitHub Actions: the three continuous integration jobs.",
 "23-github-commit-history":       "Commit history on the develop branch.",
 "22-github-release":              "Release v0.9.0 with the runnable jar attached.",
 "27-appointment-reminders":       "Appointment reminders, split into who can be emailed and who must be telephoned.",
}
